...
// Generated: 2026-06-02T21:58:59.747Z
...
const PAINTINGS = [
  ...
  },
  {
    ...
    "intro": "A painting about my fear of time, of losing loved ones to it and of it passing so fast by me.",
    "storyTitle": "",
    "story": "As for this quick sketch (and many others), I can't remember the meanings or how I was thinking while making it. I mean, it's been 4 years now, and I never really spoke as much about it or even wrote. But I think I can analyze it with you through the feeling I can remember from it and the half a memory I have.\n\nAlong with my thoughts and feelings of today, per usual.\n\nI was a bit invested in mixing my art style with the comic books style at that time, and this sketch is one of a few more.\n\nI remember feeling like I'm being watched most of the time (I'm pretty sure that was because of the amount of maladaptive daydreaming I have (I'm mocking myself here)), and because of the amount of thoughts that I was having, that turned out to be OCD. At some point, I thought I was going crazy, until I realized it was just me. \"The thoughts are on me even if one aren't completely their thoughts, you still are a bit of them in ways.\" is what I'd always think.\n\nIf you tried to look under every eye with me there, you'd find that I had \"Unknown\" written under each of them, and each eye had its own kind of vision. And I think it was accidental that I made the blind eye looking at the lost third eye, but if it weren't, then it's pretty smart.\n\nI'm actually trying to keep track of the details. It's insane. I can't believe that I didn't have my time with that painting throughout each year since I made it.\n\nI had a pretty big fear of time, of losing loved ones to it and of it passing so fast by me, and I'd usually doubt that it's a fear of mine and that I'm only doing it for attention (I still feel that way). You'd be able to know my fear of time passing through the clock, and my fear of losing loved ones through the dead rose coming out of my brain; together, they make the perfect mix of both. And I don't know if you can see it, but both of their inked shadows are going in different ways.\n\nThe clock is going clockwise, while the rose's turned to the nonclockwise way, with what I noticed now, the leafs that are on the left next to my head. Per usual, I let you have your meanings. I'm a bit lazy to explain any (jk, I like to let people have their space of thoughts when it comes to my art).\n\nIf you took a quick glimpse of my not so bright wings, you'd notice that they're fading. I remember feeling my heavy heart and helpless screams of what I thought could be freedom as I made the taken out heart and the fading wings.\n\nYou'll see the helplessness in my eyes. One is in the delusions and also cycles of hopeless tries, and the other is blind, and the one that could have made me know a way out is within, and it's empty. Which used to be an art style of mine as well, but that painting and another are the only two with every eye being blind in them. Though the external ones can see, even the blind one can feel.\n\nAs for the wounds all over my face, they started with a mistake as I was coloring, actually, but the one on my mouth was intentional. As I was looking up with hopeless emotions on my face, I remember wanting to pray to God, but at that time everything I'd pray for felt like it wasn't there or like it's not helping to pray. So, with hopeless emotions and confused thoughts, I'm looking up, hoping that I'd feel God's understanding after the scars I felt from speaking about wanting to live a life of my own, the betrayal I felt from feeling unheard by everyone, and my words abused by misunderstandings from the ones who gave their ears, and from crying my words out to God but feeling like God is giving my prayers to the ones around me but me.\n\nYou'd notice and feel the intensity of it all through the comic like tensed lines, like there's a fight, but you can only see it through the details.\n\nAt the end of the day, I was my disease of mind. The way I let it all control my actions to \"save loved ones\", the harm I put myself through to satisfy these thoughts that won't ever be satisfied like that, the each one last time and we'll be gone, the silence I had to choose because I couldn't speak about it by the same thoughts for the sake of loved ones. I let the delusions and illusions take all the control they wanted; therefore, I'm a part of my disease. Is that the matter? I don't think I'm certain, though I know a part of it is absolute.\n\nI was basically analyzing this painting like I'm one of the viewers. I truly can't remember a lot of it for certain. I'm only memorizing through feelings at the time and the feelings what I'm seeing and think I felt back then, and looking at the details.\n\nFun fact: I don't remember how the name of the painting was wrote exactly, or if there was more of it. That's how bad my memory is lol.",
