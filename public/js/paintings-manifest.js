...
// Generated: 2026-06-02T22:37:30.883Z
...
const PAINTINGS = [
  {
    ...
    "year": "2022–2023",
    "medium": "Mainly acrylics, colored pencils & ink",
    ...
    "storyTitle": "Who's watching whom - self-portrait",
    "story": "It's a small sketch that I made back in 2022, or around that time. I'm not really a fine one when it comes to memorizing, though, ironically, I'm a very nostalgic person. And a part of this painting is about nostalgia.\n\nThere's the old TV screen with an old picture I found of me and my brother. Our siblingshood is not the best out there, and at the time I made this painting, it was at its worst. I remember begging God to let us be friends, and I remember feeling jealous of his friends for being friends with him. And he, as an older brother, he'd usually get his friends to sit with him at the time, and I'd pass next to his room and hear them laugh together and go back to my room and bawl my eyes out. And I never really found anyone talking about older brother issues (lol). I'd always find people making paintings and art pieces, regardless of the art form, and talking about parents' issues or family issues, and I think my brother would relate to parents' issues.\n\nI've never (until I made this painting) found someone talking about older brother issues. I've always been attached to him, and I'd always try to get closer to him, but he'd always push me away in every way when we were kids. He never really got it, though I always understood how he feels about our parents, because he pushed me to feel this way about him. But he was a kid, and I understood that even though I was younger. What can I say, though? It's always the younger sister (?).\n\nYou can see what I mean by noticing the black paint on his mouth that also kinda makes his mouth feel like it's opened in an old 2000s cartoonist game style, which shows he wasn't taken seriously by older generations.\n\nAnd if you looked next to him, it's younger me as well, but there're no features, just pure blur and a third eye (which was a very, very, very common thing in my paintings to find at the time—the third eye). But you could still tell that it's the head of a child.\n\nBut the child is pretty conflicted, many wrong things she couldn't get, many thoughts she thought were normal but really aren't. She would get used all the time by everyone, even by the person she thought would understand the struggle, but he was the main reason.\n\nWhen you get your eyes to look a bit higher from the TV placement, you'd see a receiver with random numbers that I don't remember the meaning behind, but I remember while writing them at the time, I was like, \"nah, no worries, future me would understand.\" No, Mario, I do NOT understand.\n\nBut if you looked a bit higher, which is probably the place you looked at when I told you to look higher, you'd find a hanged clock with a golden frame and blood on its glass, and I'm not really here to put meanings into your head. You're free to have your own thoughts. I'll tell you why later on.\n\nNow, can you look down? Yeah, right there. The chocolate cake.\n\nA friend of mine drew it for me in a painting she made for me on my birthday around that time, and I mentioned it a few times after in other paintings. Growing up, we wouldn't really celebrate birthdays as much. We used to when I was so young that I can't quite remember it vividly, but I can remember some details of it that were very attractive to my childish eyes.\n\nSo that cake felt very real to me when the friend painted it, especially that I'd always feel lonely on my birthdays at the time. I remember even begging Mom to plot a birthday surprise for me with my friends. That never happened to this day, by the way, lol.\n\nAnd since we're finally talking about this day, even though this painting was around the time of 2022 or the beginning of 2023, this next part I feel very related to. As you look at me (or an older version of me that's relatable now more than ever), you'd see my eyes, how sparkling white they are. You wouldn't know if I'm crying or if I'm possessed by the electrons of that TV with the memories it's playing on repeat, the blood on my mouth, and the question marks engraved on my head. Like the confusion never left, but got more obvious on me. With the blindness of the possession taking control over my soul (since eyes are the windows of the soul). With the blood on my mouth showing that I still beat myself up for things I'm not responsible for, even after growing up, as well as how I got beaten up for things I was never responsible for.\n\nIt's 2026 as I'm writing this, and I now see this painting differently because my life has changed a bit. Thing is, as I grow up, I see different meanings and new details in my art that I don't remember even making on purpose.\n\nAnd that's why I never say the meanings behind my art. I can let you know the story that opened my heart to it, but I won't tell you the meanings. If you noticed throughout my yapping, I didn't even tell future—current now—me the meaning behind any of it. I only feel my meanings. If I were to be able to say them, I wouldn't have painted them.\n\nAnd btw, the blindness and white sparkling spots were a mistake at first. The paper was a pretty low-quality one, and this painting was mainly made of acrylics, so it got ripped off. But as an artist, you gotta always find a solution, and as a human, you'll always find the meaning behind the mistakes.\n\nIt wasn't the only mistake that turned into a meaning throughout this painting, by the way. ;)",
  ...
  },
  {
    ...
    "subtitle": "Self-portrait",
    "year": "2022",
    "medium": "Water-colors, Colored Pencils & Ink",
    "dimensions": "10.5×15.5",
    "series": "Time Studies",
    "tags": [
      "self-portrait",
    ...
    "icon": "◎",
    "description": "<p>I remember feeling like I'm being watched most of the time, and because of the amount of thoughts that I was having, that turned out to be OCD.</p><p>I had a pretty big fear of time, of losing loved ones to it and of it passing so fast by me.</p>",
    "palette": {
      "accent": "#081228",
    ...
    "intro": "A quick sketch about losing myself to the fears of time time passing without being full of my surroundings yet, and thinking I'd lose loved ones to the threatens or warnings of OCD.",
    "storyTitle": "",
    "story": "As for this quick sketch (and many others), I can't remember the meanings or how I was thinking while making it. I mean, it's been 4 years now, and I never really spoke as much about it or even wrote. But I think I can analyze it with you through the feeling I can remember from it and the half a memory I have. Along with my thoughts and feelings of today, per usual. I was a bit invested in mixing my art style with the comic books style at that time, and this sketch is one of a few more. I remember feeling like I'm being watched most of the time (I'm pretty sure that was because of the amount of maladaptive daydreaming I have (I'm mocking myself here), and because of the amount of thoughts that I was having, that turned out to be OCD. At some point, I thought I was going crazy, until I realized it was just me. \"The thoughts are on me even if one aren't completely their thoughts, you still are a bit of them in ways.\" is what I'd always think. If you tried to look under every eye with me there, you'd find that I had \"Unknown\" written under each of them, and each eye had its own kind of vision. And I think it was accidental that I made the blind eye looking at the lost third eye, but if it weren't, then it's pretty smart. I'm actually trying to keep track of the details. It's insane. I can't believe that I didn't have my time with that painting throughout each year since I made it. I had a pretty big fear of time, of losing loved ones to it and of it passing so fast by me, and I'd usually doubt that it's a fear of mine and that I'm only doing it for attention (I still feel that way). You'd be able to know my fear of time passing through the clock, and my fear of losing loved ones through the dead rose coming out of my brain; together, they make the perfect mix of both. And I don't know if you can see it, but both of their inked shadows are going in different ways. The clock is going clockwise, while the rose's turned to the nonclockwise way, with what I noticed now, the leafs that are on the left next to my head. Per usual, I let you have your meanings. I'm a bit lazy to explain any (jk, I like to let people have their space of thoughts when it comes to my art). If you took a quick glimpse of my not so bright wings, you'd notice that they're fading. I remember feeling my heavy heart and helpless screams of what I thought could be freedom as I made the taken out heart and the fading wings. You'll see the helplessness in my eyes. One is in the delusions and also cycles of hopeless tries, and the other is blind, and the one that could have made me know a way out is within, and it's empty. Which used to be an art style of mine as well, but that painting and another are the only two with every eye being blind in them. Though the external ones can see, even the blind one can feel. As for the wounds all over my face, they started with a mistake as I was coloring, actually, but the one on my mouth was intentional. As I was looking up with hopeless emotions on my face, I remember wanting to pray to God, but at that time everything I'd pray for felt like it wasn't there or like it's not helping to pray. So, with hopeless emotions and confused thoughts, I'm looking up, hoping that I'd feel God's understanding after the scars I felt from speaking about wanting to live a life of my own, the betrayal I felt from feeling unheard by everyone, and my words abused by misunderstandings from the ones who gave their ears, and from crying my words out to God but feeling like God is giving my prayers to the ones around me but me. You'd notice and feel the intensity of it all through the comic like tensed lines, like there's a fight, but you can only see it through the details. At the end of the day, I was my disease of mind. The way I let it all control my actions to \"save loved ones\", the harm I put myself through to satisfy these thoughts that won't ever be satisfied like that, the each one last time and we'll be gone, the silence I had to choose because I couldn't speak about it by the same thoughts for the sake of loved ones. I let the delusions and illusions take all the control they wanted; therefore, I'm a part of my disease. Is that the matter? I don't think I'm certain, though I know a part of it is absolute. I was basically analyzing this painting like I'm one of the viewers. I truly can't remember a lot of it for certain. I'm only memorizing through feelings at the time and the feelings what I'm seeing and think I felt back then, and looking at the details. Fun fact: I don't remember how the name of the painting was wrote exactly, or if there was more of it. That's how bad my memory is lol.",
    "quote": "There's a fight, but you can only see it through the details.",
    "images": {
      "display": "main.jpg",
      "thumb": "main.jpg",
      "details": [
        {
          "file": "detail-1.jpg",
          "caption": "I was a bit invested in mixing my art style with the comic books style at that time, and this sketch is one of a few more. I remember feeling like I'm being watched most of the time (I'm pretty sure that was because of the amount of maladaptive daydreaming I have (I'm mocking myself here)), and because of the amount of thoughts that I was having, that turned out to be OCD. At some point, I thought I was going crazy, until I realized it was just me. \"The thoughts are on me even if one aren't completely their thoughts, you still are a bit of them in ways.\" is what I'd always think. If you tried to look under every eye with me there, you'd find that I had \"Unknown\" written under each of them, and each eye had its own kind of vision. And I think it was accidental that I made the blind eye looking at the lost third eye, but if it weren't, then it's pretty smart."
        },
        {
          "file": "detail-2.jpg",
          "caption": "I'm actually trying to keep track of the details. It's insane. I can't believe that I didn't have my time with that painting throughout each year since I made it. I had a pretty big fear of time, of losing loved ones to it and of it passing so fast by me, and I'd usually doubt that it's a fear of mine and that I'm only doing it for attention (I still feel that way). You'd be able to know my fear of time passing through the clock, and my fear of losing loved ones through the dead rose coming out of my brain; together, they make the perfect mix of both. And I don't know if you can see it, but both of their inked shadows are going in different ways. The clock is going clockwise, while the rose's turned to the nonclockwise way, with what I noticed now, the leafs that are on the left next to my head. Per usual, I let you have your meanings. I'm a bit lazy to explain any (jk, I like to let people have their space of thoughts when it comes to my art)."
        },
        {
          "file": "detail-3.jpg",
          "caption": "If you took a quick glimpse of my not so bright wings, you'd notice that they're fading. I remember feeling my heavy heart and helpless screams of what I thought could be freedom as I made the taken out heart and the fading wings."
        },
        {
          "file": "detail-4.jpg",
          "caption": "You'll see the helplessness in my eyes. One is in the delusions and also cycles of hopeless tries, and the other is blind, and the one that could have made me know a way out is within, and it's empty. Which used to be an art style of mine as well, but that painting and another are the only two with every eye being blind in them. Though the external ones can see, even the blind one can feel. As for the wounds all over my face, they started with a mistake as I was coloring, actually, but the one on my mouth was intentional. As I was looking up with hopeless emotions on my face, I remember wanting to pray to God, but at that time everything I'd pray for felt like it wasn't there or like it's not helping to pray. So, with hopeless emotions and confused thoughts, I'm looking up, hoping that I'd feel God's understanding after the scars I felt from speaking about wanting to live a life of my own, the betrayal I felt from feeling unheard by everyone, and my words abused by misunderstandings from the ones who gave their ears, and from crying my words out to God but feeling like God is giving my prayers to the ones around me but me. You'd notice and feel the intensity of it all through the comic like tensed lines, like there's a fight, but you can only see it through the details."
        }
      ]
    }
  },
...
const EXHIBITION_LAYOUTS = [
  {
    "type": "text-painting",
    "paintingId": "whos-watching-whom",
    "seriesName": "Self-portraits",
    "seriesNote": "the series that started everything"
  },
  {
    "type": "painting-text",
    "paintingId": "feelings",
